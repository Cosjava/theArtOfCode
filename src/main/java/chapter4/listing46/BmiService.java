...
/**
 * Listing 4.5 – Refactoring for narrative clarity.
 *
 * <p>This listing refactors the <strong>listing 4.4</strong> into a more
 ...
 * The algorithm remains identical to <strong>listing 4.4</strong>, but the refactoring improves
