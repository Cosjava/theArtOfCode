...
/**
 * Listing 4.5 – Refactoring for clearer data modeling using records.
 *
 * <p>This listing refactors the rough draft from <strong>listing 4.4</strong>.
 ...
 *
 * <p>The next <strong>listing 4.6</strong> will build on this version,
