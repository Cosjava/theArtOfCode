...
/**
 * Listing 5.2 – A richer data transfer object with builder and equality methods.
 *
 * <p>This listing expands on the simple DTO from listing 5.1 by introducing
 * a {@link Person} class that models a person’s identity with two attributes:
