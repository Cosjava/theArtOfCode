...
/**
 * Listing 5.5 – Computing BMI statistics using records, streams, and pattern matching.
 *
 * <p>The {@link BmiService} computes body mass index (BMI)
 * categories for a collection of {@link chapter5.listing54.PhysicalProfile} instances
 ...
 * <strong>Listing 5.6</strong> will refactor this version to reveal its true
 * intent.</p>
 */
@Slf4j
