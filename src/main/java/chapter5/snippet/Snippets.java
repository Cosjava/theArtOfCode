...
/**
 * Supplementary snippets for Chapter 5 – Clarity of intent.
 *
 * <p>This class collects short, focused examples that illustrate core
 * principles
 * discussed in Chapter 5. The snippets contrast mutable and immutable code
...
public class Snippets {
  ...
  public static void main(String[] args) {
    ...
    log.info("Saying hello: {}", new Person("John", "Bob").hello());
  }
